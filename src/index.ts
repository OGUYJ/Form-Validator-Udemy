...
username.addEventListener('change', function(e: Event){
...
//Lorsque mon input change, je change son border color selon qu'il soit au bon format ou non.
email.addEventListener('change', function(e: Event){
...
//Lorsque mon input change, je change son border color selon qu'il soit au bon format ou non.
password.addEventListener('change', function(e: Event){
...
const confirmation = document.getElementById("confirm") as HTMLInputElement;

//Je change son border color seulement s'il match avec la value de password
confirmation.addEventListener('change', function(e: Event){
